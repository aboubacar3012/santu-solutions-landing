...
export default function Footer() {
  return (
    <footer className="py-10 px-8 sm:px-12 bg-neutral-950 border-t border-neutral-800">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-8">
          <div className="md:col-span-2">
            <p className="text-xl font-bold text-white mb-3">Santu Engineering</p>
        ...
        <div className="pt-8 border-t border-neutral-800 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <p className="text-sm text-neutral-500">© 2026 Santu Engineering</p>
